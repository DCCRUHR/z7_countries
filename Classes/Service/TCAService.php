            ...
            ExtensionManagementUtility::addTCAcolumns($table, [
                self::FIELD_NAME_MODE => [
                    ...
                    'config' => [
                        ...
                        'items' => [
                            ['label' => 'LLL:EXT:z7_countries/Resources/Private/Language/locallang_db.xlf:*.' . self::FIELD_NAME_MODE . '.0', 'value' => '0'],
                            ['label' => 'LLL:EXT:z7_countries/Resources/Private/Language/locallang_db.xlf:*.' . self::FIELD_NAME_MODE . '.1', 'value' => '1'],
                            ['label' => 'LLL:EXT:z7_countries/Resources/Private/Language/locallang_db.xlf:*.' . self::FIELD_NAME_MODE . '.2', 'value' => '2'],
                        ],
                        'default' => '0'
                    ]
                ],
